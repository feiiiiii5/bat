...
## Bugfixes
- Expand tabs using terminal columns instead of bytes, so that multi-byte characters before a tab no longer make the tab stop land early and shift the `--style=grid` column, see #4018 (@feiiiiii5)
